...
<div>
    <template v-for="field in fields">
		<input @click="show(field.name)" class="btn btn-default" v-model="formModel[field.name]"></input>
</template>
</div>
</template>
<script>
...
export default {
    ...
    methods: {
        show: function(field) {
            var self = this;
            creat_new_modal(self.formModel[field]).then(function(value) {
                self.formModel[field] = value
            }, function(error) {
                console.log(error)
            })
        }
