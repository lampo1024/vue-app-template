<template>
<div>
	<jm-input v-model="inputValue" :placeholder="请输入" @change.native="handleChange" @click.native.self="openModal"></jm-input>
	<input type="text" @focus="openModal" v-model="checkedItems" />
